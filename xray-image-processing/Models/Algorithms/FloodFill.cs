...
// source: https://rosettacode.org/wiki/Bitmap/Flood_fill#C.23
namespace XRayImageProcessing.Models.Algorithms
{
    public class FloodFill
    {
        ...
        public void Fill(Bitmap bmp, Point pt, Color targetColor, Color replacementColor)
        {
